## La balise article (ATTENTION les exemples de structures donnés dans cette page ne sont pas entièrement valide pour le W3C)
...
https://developer.mozilla.org/fr/docs/Web/CSS/border-spacing

## La propriété empty-cells
https://developer.mozilla.org/fr/docs/Web/CSS/empty-cells
